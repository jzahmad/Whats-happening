          ...
          <div class="col-12">
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                ...
                $latestEventQuery = "SELECT * FROM events ORDER BY SubmitDate DESC LIMIT 1";
                ...
                if ($latestEventResult) {
                  ...
                  if ($latestEvent) {
                    echo '<div class="swiper-slide">
                            <a href="single-post.php?EventID=' . $latestEvent['EventID'] . '" class="img-bg d-flex align-items-end" style="background-image: url(\'assets/img/post-slide-2.jpg\');">
                              <div class="img-bg-inner">
                                <h2>Latest Added Event</h2>
                                <p><strong>' . $latestEvent["EventTitle"] . ':</strong> ' . $latestEvent["EventDesc"] . '</p>
                              </div>
                            </a>
                          </div>';
                  }
                ...
                if ($happeningSoonResult) {
                  $happeningSoonEvent = mysqli_fetch_assoc($happeningSoonResult);
                  if ($happeningSoonEvent) {
                    echo '<div class="swiper-slide">
                            <a href="single-post.php?EventID=' . $happeningSoonEvent['EventID'] . '" class="img-bg d-flex align-items-end" style="background-image: url(\'assets/img/post-slide-3.jpg\');">
                              <div class="img-bg-inner">
                                <h2><strong>What\'s Happening Soon</strong></h2>
